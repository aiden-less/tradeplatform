...
public class HttpClientUtils {
    ...
    public static String doGetSSL(String url) {
        return doGetSSL(url, null, CHARSET);
    }
    ...
    public static String doGet(String url, Map<String, String> params, String charset) {
        ...
        try {
            url += handelParam(params, charset);
    ...
    private static String handelParam(Map<String, String> params, String charset) throws IOException {
        ...
        paramStr.append("?" + EntityUtils.toString(new UrlEncodedFormEntity(pairs, charset)));
