...
/**
 * Created by 旺旺 on 2020/3/23.
 */
@Data
@Alias("LctFrozenAssets")
@Table(name = "lct_frozen_assets")
public class LctFrozenAssets implements Serializable {

    private static final long serialVersionUID = -7076178286133224113L;
