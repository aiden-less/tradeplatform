...
public class WeChatPayCommonUtils {
    //微信支付package字段
    public static String FIELD_PACKAGE = "Sign=WXPay";
     ...
     * @return
     */
    public static boolean isWechatPaySign(Map<String, String> map, String apiKey) {
    ...
    //退款的请求方法
    public static String refundRequest(String requestUrl, String requestMethod, String outputStr) throws Exception {
