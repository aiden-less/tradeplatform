...
public class WithdrawService extends BaseService {
     ...
     * @param settlementId
     */
    public Map<String, Object> applyWithdraw(String userId, BigDecimal amount, Integer settlementId, String payPassword, String toAddress) {
        ...
        TradeCoin tradeCoin = selectOneByWhereString(TradeCoin.Settlement_id + "=", settlementId, TradeCoin.class);
        ...
        CctAssets sourceCctAssets = userAssetsService.getAssetsBySettlementId(userId, settlementId);
        ...
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus transactionStatus) {
                ValueCheckUtils.notZero(userAssetsService.decreaseUserAssets(userId, decreaseAmount, settlementId), "余额不足");
                ...
                assetsTurnoverService.createAssetsTurnover(
                        userId, TURNOVER_TYPE_WITHDRAW, decreaseAmount, userId, COMPANY_ID, "审核中", settlementId,
                        turnoverDetail, extralParam
                );
        ...
        return ImmutableMap.of("amount", amount, "settlementId", settlementId);
    }
        ...
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus transactionStatus) {
                ...
                if (auditStatus == SettlementConst.USERASSETS_RECHARGE_AUDIT_PASS) {
                    ...
                    ValueCheckUtils.notZero(userAssetsService.increaseUserAssets(userId, backAmount, settlementId), errorMsg);
