...
//        }
        ...
        if (UserConst.MSG_CODE_TYPE_RESET_LOGINPWD == msgType) { //重置登陆密码
            ...
            User u = selectOneById(userId, User.class);
            phoneNumber = u.getPhoneNumber();
        }

        ValueCheckUtils.notEmpty(msgType, "短信类型有误");
        ValueCheckUtils.notEmpty(msgType, "请输入手机号");
...
//        String content = "【" + msgCode + "】。正在尝试" + msgTypeStr + "。验证码十五分钟内有效";
        String content = "您正在" + msgTypeStr + "，验证码：" + msgCode + "，十五分钟内有效";
